    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-8">
      ...
      >
        ...
        <div className="bg-card rounded-xl shadow-lg border border-border p-8">
          <h2 className="text-2xl font-bold text-headline text-center mb-2">নিবন্ধন করুন</h2>
          <p className="text-center text-caption mb-6">নতুন অ্যাকাউন্ট তৈরি করুন</p>
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 text-caption" size={18} />
                <input
                  type="text"
                  name="name"
                  value={formData.name}
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="absolute left-3 top-1/2 -translate-y-1/2 text-caption" size={18} />
                <input
                  type="tel"
                  name="phone"
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-caption" size={18} />
                <input
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-caption hover:text-foreground"
                >
            ...
            <div className="flex items-start gap-2">
              ...
              <label htmlFor="terms" className="text-sm text-caption">
                আমি{" "}
                <Link to="/terms" className="text-primary hover:underline">শর্তাবলী</Link>
                {" "}এবং{" "}
                <Link to="/privacy-policy" className="text-primary hover:underline">গোপনীয়তা নীতি</Link>
                {" "}মেনে নিচ্ছি।
              </label>
            </div>
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-sm text-caption">অথবা</span>
            <div className="flex-1 h-px bg-divider" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-sm font-medium">গুগল</span>
            </motion.button>
            ...
            >
              ...
              <span className="text-sm font-medium">ফেসবুক</span>
            </motion.button>
          </div>

          {/* Login Link */}
          <p className="text-center text-sm text-caption mt-6">
